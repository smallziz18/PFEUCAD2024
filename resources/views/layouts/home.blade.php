...
<section class="bg-white py-8">
    <div class="flex items-center mb-4">
        ...
        <p class="text-lg text-blue-700 font-semibold">Découvrez nos annonces les plus populaires :</p>
    </div>
...
<section class="bg-white py-8">
    ...
    <div class="flex items-center mb-4">
        ...
        <p class="text-lg text-blue-700 font-semibold">Découvrez nos annonces les plus recente :</p>
    </div>
