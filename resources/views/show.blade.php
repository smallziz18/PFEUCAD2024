...
<section class="bg-white py-8">
    <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/2 md:ml-8 p-4">
            <div class="bg-gray-200 border-4 border-blue-300 rounded-lg">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __($annonce->titre) }}
            </h2>
            <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-200 leading-tight">Détails de l'annonce</h3>
                <p class="w-full font-bold text-red-700">Prix : {{ $annonce->prix }} FCFA</p>
            ...
            <p>Description :</p>
            <div class="h-48 overflow-auto border-4 border-blue-700 rounded-lg">
